    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex space-x-10 h-full">
                <!-- Aktif (Featured) -->
                <a href="#featured" class="desktop-nav-link inline-flex items-center px-1 border-b-2 border-purple-600 text-sm font-bold text-purple-700 h-full transition-colors">
                    Featured
                </a>
                <a href="#catalogue" class="desktop-nav-link inline-flex items-center px-1 border-b-2 border-transparent text-sm font-semibold text-gray-500 hover:text-gray-900 hover:border-gray-300 h-full transition-colors">
                    Catalogue
                </a>
                <a href="#how-it-works" class="desktop-nav-link inline-flex items-center px-1 border-b-2 border-transparent text-sm font-semibold text-gray-500 hover:text-gray-900 hover:border-gray-300 h-full transition-colors">
                    How it Works?
                </a>
                <a href="#support" class="desktop-nav-link inline-flex items-center px-1 border-b-2 border-transparent text-sm font-semibold text-gray-500 hover:text-gray-900 hover:border-gray-300 h-full transition-colors">
                    Support
                </a>
            </div>
