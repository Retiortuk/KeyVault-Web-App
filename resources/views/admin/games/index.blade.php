...
@section('content')
<!-- Header Section -->
<x-admin.page-header title="Game Management" subtitle="Manage games catalogue, price, and availability.">
    <button onclick="toggleModal('modal-add-game')" class="w-full md:w-auto bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-6 rounded-xl transition-colors shadow-md shadow-purple-200 flex items-center justify-center gap-2">
