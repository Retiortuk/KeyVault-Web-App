<footer class="bg-gray-50 border-t border-gray-100 py-10 mt-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
        <div class="flex items-center gap-2">
            ...
            <a href="/" class="text-xl font-black text-purple-700 tracking-tight">KeyVault</a>
        </div>

        <p class="text-xs text-gray-500 font-medium text-center">
            © {{ date('Y') }} KeyVault. All Rights Reserved.
        </p>

        <div class="flex flex-wrap justify-center gap-4 md:gap-6">
            <a href="#" class="text-xs font-semibold text-gray-500 hover:text-purple-700 transition-colors">Privacy Policy</a>
            <a href="#" class="text-xs font-semibold text-gray-500 hover:text-purple-700 transition-colors">Terms of Service</a>
            <a href="#" class="text-xs font-semibold text-gray-500 hover:text-purple-700 transition-colors">Support</a>
        </div>
