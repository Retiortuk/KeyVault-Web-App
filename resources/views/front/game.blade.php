        ...
        <div class="grid grid-cols-1 py-4 md:py-10 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            <div class="lg:col-span-5 flex flex-col h-full justify-center">
                ...
                <div class="mt-auto pt-4">
                        <a href="#" class="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold py-4 px-8 rounded-2xl shadow-lg shadow-purple-600/30 transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3 text-lg">
