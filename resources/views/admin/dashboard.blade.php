...
<div class="mb-8">
    ...
    <p class="text-gray-500 mt-1">Welcome back, {{ $user }}. Here's what's happening today.</p>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:border-purple-200 hover:shadow-md transition-all">
        ...
        <p class="text-3xl font-bold text-gray-900 mt-1">{{ $totalGames }}</p>
    </div>
    ...
    <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:border-purple-200 hover:shadow-md transition-all">
        ...
        <p class="text-3xl font-bold text-gray-900 mt-1">{{ $availableKeys }}</p>
    </div>
    ...
    <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:border-purple-200 hover:shadow-md transition-all">
        ...
        <p class="text-3xl font-bold text-gray-900 mt-1">{{ $successTransactions }}</p>
    </div>
        ...
        <table class="w-full text-left text-sm text-gray-600">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50/50">
                    ...
                    <td class="px-6 py-4 font-bold text-gray-900">{{ $transaction->game->title }}</td>
                    <td class="px-6 py-4 font-mono text-gray-500">{{$transaction->gameKey?->license_key ?? 'Pending'}}</td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 text-right font-medium text-gray-900">Rp. {{ number_format($transaction->amount, 0, ',', '.') }}</td>
                </tr>
                @empty
                <tr>
                    <td colspan="5" class="px-6 py-4 text-center text-gray-500">No recent transactions found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
